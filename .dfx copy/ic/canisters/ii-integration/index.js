...
import { idlFactory } from './ii-integration.did.js';
export { idlFactory } from './ii-integration.did.js';
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ii-integration.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ii-integration canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ii-integration.did.js")._SERVICE>}
 */
export const ii_integration = createActor(canisterId);
